describe('Fetch data from fixture file using cypress fixture method using variables', function () {
    ...
    before("Get data from fixture data", function () {
        ...
        //  //as()  --->
         cy.fixture('ABC/user1.json').as("fixtFileData")

        // // 3. this keyword
        // cy.fixture('ABC/user1.json').then(function (fixtFileData) {
    ...
    // using fixture with cypress variabls(alies)
    //cy.fixture('ABC/user1.json').as("fixtFileData") //declare describe block in
